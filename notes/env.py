...
ALLOWED_ORIGIN_RAW: str = os.getenv("ALLOWED_HOSTS", "")
CORS_ALLOWED_HOSTS_RAW: str = os.getenv("CORS_ALLOWED_ORIGINS", "")
DEBUG_RAW: str = os.getenv("DEBUG", "")
CSRF_TRUSTED_HOSTS_RAW: str = os.getenv("CSRF_TRUSTED_ORIGINS", "")
NOTE_ENCRYPTION_KEY: str = os.getenv("NOTE_ENCRYPTION_KEY", "")
BREVO_API_KEY: str = os.getenv("BREVO_API_KEY", "")
BREVO_SMTP_KEY: str = os.getenv("BREVO_SMTP_KEY", "")
ENV: str = os.getenv("ENVIRONMENT", "")
CLOUDINARY_CLOUD_NAME: str = os.getenv("CLOUDINARY_CLOUD_NAME", "")
CLOUDINARY_API_KEY: str = os.getenv("CLOUDINARY_API_KEY", "")
CLOUDINARY_SECRET_KEY: str= os.getenv("CLOUDINARY_SECRET_KEY", "")
...
ALLOW_DEBUG = parser.parse_bool(DEBUG_RAW)
